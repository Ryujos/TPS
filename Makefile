...
OBJ = Variables.o Equations.o Write_Reaction_Trajectory.o TPS.o r1279.o gauss_only.o ran2.o
...
TPS.o: TPS.f90 Variables.o Equations.o Write_Reaction_Trajectory.o
	$(FC) $(FFLAGS) -c TPS.f90

Write_Reaction_Trajectory.o: Write_Reaction_Trajectory.f90 Equations.o
...
clean:
	rm -f $(OBJ) $(TARGET) *.mod Write_React_Traj.dat gauss_only.f
